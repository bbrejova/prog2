...
## Oznamy
  ...
  - Spôsob, ktorým bude určené výsledné hodnotenie, je uvedený v
    [pravidlách](./Letný_semester,_pravidlá.md).
...
![Výsledný vzhľad aplikácie.](Kalkulacka1.png){:width=420px}
...
[Vzhľad aplikácie po pridaní ovládacích prvkov.](../files/Kalkulacka2.png)
[Po zviditeľnení deliacich čiar mriežky.](../files/Kalkulacka3.png)
...
![Vzhľad aplikácie po nastavení okrajov.](../files/Kalkulacka4.png "Vzhľad aplikácie po nastavení okrajov.")
...
triedy `GridPane`: ![Vzhľad aplikácie po dokončení návrhu rozloženia
ovládacích prvkov v mriežke.](../files/Kalkulacka5.png
...
![Vzhľad aplikácie po pridaní prvkov v pravej časti
okna.](Kalkulacka6.png
"Vzhľad aplikácie po pridaní prvkov v pravej časti okna.") Vidíme
