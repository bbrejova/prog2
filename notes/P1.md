...
### Priebeh semestra
  ...
  - Predmet sa bude riadiť [pravidlami pre letný
    semester](./Letný_semester,_pravidlá.md).
...
### Softvér potrebný na tomto predmete
  ...
  - [Informácie o inštalácii a základnom použití uvedeného
    softvéru](./Letný_semester,_softvér.md).
...
```
  ...
  - Program je potrebné skompilovať javovským kompilátorom a následne
    ...
    [osobitnej stránke](./Letný_semester,_softvér.md). Po
...
[Súbor:JPamat1.png](./Súbor:JPamat1.png.md)
...
[Súbor:JPamat2.png](./Súbor:JPamat2.png.md)
