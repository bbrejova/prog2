...
prednášky](./Letný_semester,_prednáška_č._5.md) *zostupné*
...
\[<https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/util/Comparator.html#compare(T,T>)
...
\[<https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/lang/Iterable.html#forEach(java.util.function.Consumer>)
`forEach`\], ktorá postupne pre všetky prvky vracané iterátorom vykoná
...
a podobne).
  ...
  - Pokyny k inštalácii JavaFX, ako aj návod na skompilovanie a
    ...
    možno nájsť [tu](./Letný_semester,_softvér.md).
